...
static volatile uint8_t     flag_rx_waiting_for_stop_bit;
static volatile uint8_t     flag_rx_off;
static volatile uint8_t     rx_mask;
static volatile uint8_t     timer_rx_ctr;
static volatile uint8_t     bits_left_in_rx;
